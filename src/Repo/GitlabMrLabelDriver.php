...
class GitlabMrLabelDriver implements RemoteRepoDriver
{
    ...
    public function getPrs(ProjectRepoConfig $projectRepoConfig): array
    {
        ...
        return array_map(function (array $rawMr) {
            $selector = GitlabRawDataConverter::buildSelectorFromRawData($rawMr);

            return GitlabRawDataConverter::buildPrFromRawData($rawMr, $selector);
